...
public class Project extends JFrame implements ActionListener{
 String meter;
    Project(String meter, String person){
        ...
        ImageIcon ic =  new ImageIcon(ClassLoader.getSystemResource("icon/Light-bulb.jpg"));
        Image i3 = ic.getImage().getScaledInstance(1300, 640,Image.SCALE_DEFAULT);
        ...
        ImageIcon icon1 = new ImageIcon(ClassLoader.getSystemResource("icon/customer details.png"));
        ...
        ImageIcon icon2 = new ImageIcon(ClassLoader.getSystemResource("icon/meter details.png"));
        ...
        ImageIcon icon3 = new ImageIcon(ClassLoader.getSystemResource("icon/deposit details.jpg"));
        ...
        ImageIcon icon5 = new ImageIcon(ClassLoader.getSystemResource("icon/bill details.jpg"));
        ...
        ImageIcon icon41 = new ImageIcon(ClassLoader.getSystemResource("icon/pay bill.jpg"));
        ...
        ImageIcon icon42 = new ImageIcon(ClassLoader.getSystemResource("icon/last bill.jpg"));
        ...
        ImageIcon icon4 = new ImageIcon(ClassLoader.getSystemResource("icon/pay bill.jpg"));
        ...
        ImageIcon icon6 = new ImageIcon(ClassLoader.getSystemResource("icon/last bill.jpg"));
        ...
        ImageIcon icon7 = new ImageIcon(ClassLoader.getSystemResource("icon/report icon.jpg"));
        ...
        ImageIcon icon8 = new ImageIcon(ClassLoader.getSystemResource("icon/calender.png"));
        ...
        ut1.setBackground(Color.lightGray);
        
        /* ---- Calculator ---- */
        ut2.setFont(new Font("monospaced",Font.PLAIN,12));
        ImageIcon icon9 = new ImageIcon(ClassLoader.getSystemResource("icon/calculator.jpg"));
        ...
        ut2.setBackground(Color.orange);
        
        /* ---- Web Browser ---- */
        ut3.setFont(new Font("monospaced",Font.PLAIN,12));
        ImageIcon icon10 = new ImageIcon(ClassLoader.getSystemResource("icon/web browser.jpg"));
        ...
        ImageIcon icon11 = new ImageIcon(ClassLoader.getSystemResource("icon/logout2.png"));
