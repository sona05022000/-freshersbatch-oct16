...
public class Login extends JFrame implements ActionListener{
    ...
    Login(){
        ...
        ImageIcon ic1 = new ImageIcon(ClassLoader.getSystemResource("icon/loginicon.png"));
        Image i1 = ic1.getImage().getScaledInstance(16, 16,Image.SCALE_DEFAULT);
        b1 = new JButton("Login", new ImageIcon(i1));
        b1.setBounds(330, 160, 100, 20);
        add(b1);
        
        ImageIcon ic2 = new ImageIcon(ClassLoader.getSystemResource("icon/cancelicon.png"));
        ...
        b3 = new JButton("New User ?",new ImageIcon(i4));
        ...
        ImageIcon ic3 = new ImageIcon(ClassLoader.getSystemResource("icon/login.png"));
        Image i3 = ic3.getImage().getScaledInstance(290,280,Image.SCALE_DEFAULT);
        ImageIcon icc3 = new ImageIcon(i3);
        l3 = new JLabel(icc3);
        l3.setBounds(0, 0, 290,270);
