...
import java.awt.event.*;
 class Remove_Employee implements ActionListener{
    ...
    Remove_Employee(){
        ...
        l5= new JLabel();
        l5.setBounds(0,-15,600,480);
        l5.setLayout(null);
        ImageIcon img = new ImageIcon(ClassLoader.getSystemResource("icons/removeemployee.jpg"));
        l5.setIcon(img);
        f.add(l5);
        
        l1= new JLabel("Employee Id");
        l1.setBounds(270,50,250,30);
        ...
        t= new JTextField();
        t.setBounds(420,50,150,30);
        l5.add(t);
        
         b= new JButton("Search");
        b.setBounds(330,100,100,30);
        b.addActionListener(this);
        l5.add(b);
        
          b3= new JButton("back");
        b3.setBounds(460,100,100,30);
