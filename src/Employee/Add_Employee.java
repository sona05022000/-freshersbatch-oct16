...
public class Add_Employee implements ActionListener {
   ...
   Add_Employee(){
       ...
       id15= new JLabel();
        id15.setBounds(0,0,1216,911);
        id15.setLayout(null);
        ImageIcon img = new ImageIcon(ClassLoader.getSystemResource("icons/addempl_2.jpg"));
        id15.setIcon(img);
