...
public class Print_Data implements ActionListener {
    ...
    Print_Data(String e_id){
        ...
        f.setVisible(true);
        f.setSize(449,600);
        f.setLocation(450,60);
        f.setBackground(Color.white);
        f.setLayout(null);
        
        id9= new JLabel();
        id9.setBounds(0,0,449,600);
        id9.setLayout(null);
        ImageIcon img = new ImageIcon(ClassLoader.getSystemResource("icons/print_1.jpg"));
        id9.setIcon(img);
        ...
        aid.setFont(new Font("serif",Font.BOLD,25));
        id9.add(aid);
